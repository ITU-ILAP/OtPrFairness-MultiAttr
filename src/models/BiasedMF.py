...
class BiasedMF_FairPO(BiasedMF_PCFR):
    """
    FairPO: Fair Process and Outcome.
    Same filter architecture as PCFR (process fairness via adversarial learning).
    Exposes val_loss so the runner can add an outcome fairness regularization term.
    """
    def forward(self, feed_dict):
        ...
        # Value-unfairness signal for outcome fairness penalty in the runner
        out_dict['val_loss'] = out_dict['prediction'] - feed_dict[LABEL]
        return out_dict
